...
let elements = ["div", "article", "aside", "footer", "form", "header", "main", "section",
...
let res = { Box: styled.div`${(rest)=>gp({...rest})}`}

elements.forEach(e => { res[e[0].toUpperCase() + e.slice(1)] = styled(e)`${(rest)=>gp({...rest})}`})

export const {
        Div, Article, Aside, Box, Footer, Form, Header, Main, Section, Nav,
