...
const getValueClass = (str) => {
    ...
    if(str.includes(":")){
      ...
      else if ( res.length > 1 && all.hasOwnProperty(res.at(res.length - 1)) ) {
        let value = negativo + res.pop() 
        if (res.length === 1  ) return allClass[res[0]](value)
        else if (res.length === 2 ) return allClass[res[0]][res[1]](value)
        else if (res.length === 3 ) return allClass[res[0]][res[1]][res[2]](value)
        else if (res.length === 4 ) return allClass[res[0]][res[1]][res[2]][res[3]](value)
        else if (res.length === 5 ) return allClass[res[0]][res[1]][res[2]][res[3]][res[4]](value)
        else if (res.length === 6 ) return allClass[res[0]][res[1]][res[2]][res[3]][res[4]][res[5]](value)
        else return ""
      }
      ...
      else if (res.length === 6 ) return classes[res[0]][res[1]][res[2]][res[3]][res[4]][res[5]]
      else "" 
    }
  }
